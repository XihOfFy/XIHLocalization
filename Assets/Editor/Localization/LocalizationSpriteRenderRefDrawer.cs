...
{
    [CustomPropertyDrawer(typeof(LocalizationSpriteRenderRefAttribute))]
    class LocalizationSpriteRenderRefDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                LocalizationSpriteRender lo = Selection.activeGameObject.GetComponent<LocalizationSpriteRender>();
